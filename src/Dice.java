...
public class Dice {
    ...
    public static void checkForPair(String[][] fields, String[][] communityChest, String[] chanceCards, String[] playersName, int[] playersMoney, int[] playersPosition, int[] playersJailTimeCounter, String[] fieldsInitialPrices, boolean[] isPlayerActive, int iteration, int dice1, int dice2, int pairCount) {
        //stops player's turn in dice row if player doesn't have money
            ...
            if (sumOfActivePlayers == 1) {
                ...
                if (dice1 == dice2) {
                    ...
                    if (playersJailTimeCounter[iteration] == 0) {
                        ...
                        PlayGame.isFieldFree(fields, communityChest, chanceCards, playersName, playersMoney, playersPosition, playersJailTimeCounter, fieldsInitialPrices, isPlayerActive, iteration, dice1 + dice2);
                        if (dice1 == dice2) {
                            checkForPair(fields, communityChest, chanceCards, playersName, playersMoney, playersPosition, playersJailTimeCounter, fieldsInitialPrices, isPlayerActive, iteration, dice1, dice2, pairCount);
                        }
                    } else {
